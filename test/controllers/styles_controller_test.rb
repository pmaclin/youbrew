...
class StylesControllerTest < ActionController::TestCase
  ...
  test "should create style" do
    assert_difference('Style.count') do
      post :create, style: { com_ex_image: @style.com_ex_image, name: @style.name, std_flavor_profile: @style.std_flavor_profile }
    end
  ...
  test "should update style" do
    patch :update, id: @style, style: { com_ex_image: @style.com_ex_image, name: @style.name, std_flavor_profile: @style.std_flavor_profile }
    assert_redirected_to style_path(assigns(:style))
  end
